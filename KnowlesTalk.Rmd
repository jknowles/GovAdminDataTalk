...
## The problem, we need to establish some sense of causality
...
chemical processes progress could still be made
...
## Causality is good, but it's not everything
...
- Complex patterns emerge even when the rules are simple and actors are single 
minded
...
- Good capture and ability to measure and track changes in the regulatory 
environment
